...
<div class="bg-white shadow-xl rounded-xl p-8 w-full max-w-md mx-auto mt-10">
    <div class="mb-2">
        <h1 class="text-2xl font-bold text-gray-700 mb-3">Lupa Password</h1>
    </div>


    @if (session('status'))
        <div class="bg-green-100 text-green-800 text-sm font-bold p-2 rounded-xl mb-4">
            {{ session('status') }}
        </div>
    @endif
    ...
    <div class="text-center mt-4">
        <a href="{{ route('login') }}" class="text-sm text-purple-600 hover:underline">Kembali ke Login</a>
    </div>
</div>
@endsection